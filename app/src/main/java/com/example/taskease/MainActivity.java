...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 2. Crear la Fábrica, pasándole el Repositorio.
        TaskViewModelFactory factory = new TaskViewModelFactory(repository);
        // 3. Obtener el ViewModel usando la fábrica.
        mTaskViewModel = new ViewModelProvider(this, factory).get(TaskViewModel.class);
